...
func AgencySowListHandler(w http.ResponseWriter, r *http.Request) {
	...
	url := config.Serverproto + "://" + config.Serverhost + ":" + strconv.Itoa(config.Serverport) + "/cgi-bin/agency.cgi?action=AJAX_getSoWList&include_bt=true&include_tasks=true&include_cost_centers=true"
